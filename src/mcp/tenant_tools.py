...
def register_tenant_tools(mcp: FastMCP) -> None:
    ...
    async def update_tenant(
        ...
        try:
            ...
            update_data = {}
            if establishment_name: update_data["establishment_name"] = establishment_name
            ...
            if responsible_name: update_data["responsible_name"] = responsible_name
            if responsible_email: update_data["responsible_email"] = responsible_email
            if business_name: update_data["business_name"] = business_name
            if domain: update_data["domain"] = domain
